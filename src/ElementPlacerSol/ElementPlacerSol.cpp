...
void mouse(int button, int state, int x, int y)
{
    ...
    case 0:
        ...
        if(button == 0)
        {
            float windowX = x/(float)(windowSize-1);
            float windowY = 1.0f-y/(float)(windowSize-1);
            DrawPoint* point = new DrawPoint(windowX,windowY);
        ...
        else if (button == 2)
        {
            ...
            elements.push_back(new DrawTriangle(windowX,windowY,triangleSize,red,green,blue));
        }
